										...
										<form:form commandName="BoardVO" action="/board/post/${board.bno}" method="PATCH">
											...
											<table class="table table-striped">
												<tr>
													<td>&nbsp;</td>
													<td>제목</td>
													<td><input name="subject" size="50" maxlength="100" value="${board.subject }"></td>
													<td>&nbsp;</td>
												</tr>
												<tr>
													<td>&nbsp;</td>
													<td>프로젝트</td>
													<td><input name="writer" size="50" maxlength="50" value="${board.writer}"></td>
													<td>&nbsp;</td>
												</tr>
												<tr>
													<td>&nbsp;</td>
													<td>내용</td>
													<td><textarea id="editor1" name="content" style="width:100%;height:200px;">${board.content}</textarea></td>
													<td>&nbsp;</td>
												</tr>
												<tr align="center">
													<td>&nbsp;</td>
